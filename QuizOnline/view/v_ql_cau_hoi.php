			...
			<table class="table table-hover table-fixed">
				...
				<tbody class="scrollbar">
					...
					for ($i = 0; $i < count($dsch); $i++) { 
						$khoi = $index->getTenKhoi($dsch[$i]->id_khoi);
						$dskhoi = $index->getKhoi();
						?>
						<tr>	
				...
				<div class="form-group">
					<div class="col-lg-4 col-sm-4 col-md-4 col-lg-4">
						...
						<select name="id_khoi" id="inputKhoi" class="form-control" required="required">
							...
							for ($k = 0; $k < count($dskhoi); $k++) {
								?>
								<option value="<?= $dskhoi[$k]->id_khoi?>">Khối <?= $dskhoi[$k]->id_khoi?></option>
								<?php 
							}
							?>
						</select></br >
					...
					<div class="col-lg-4 col-sm-4 col-md-4 col-lg-4">
						<label for="">Chương</label>
						<input type="number" class="form-control" name="unit" value=""></br >
						<label for="">Đáp Án A</label>
						<input type="text" class="form-control" name="da_4" value="<?=$dsch[$i-1]->da_4?>"><br />
						<label for="">Đáp Án B</label>
						<input type="text" class="form-control" name="da_1" value="<?=$dsch[$i-1]->da_1?>"><br />
					</div>
					<div class="col-lg-4 col-sm-4 col-md-4 col-lg-4">
						<label for="">Đáp Án C</label>
						<input type="text" class="form-control" name="da_2" value="<?=$dsch[$i-1]->da_2?>"><br />
						<label for="">Đáp Án D</label>
						<input type="text" class="form-control" name="da_3" value="<?=$dsch[$i-1]->da_3?>"><br />
						<label for="">Đáp Án Đúng</label>
						<input type="text" class="form-control" name="da_dung" value="<?=$dsch[$i-1]->da_dung?>"></br >
					</div>
