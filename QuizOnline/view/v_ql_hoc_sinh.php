				...
				<tbody class="scrollbar">
					...
					$dshs = $index->getDSHS();
						...
						for ($i = 0; $i < count($dshs); $i++) { 
							$tenlop = $index->getTenLop($dshs[$i]->id_lop);
												...
												<form action="" method="POST" role="form">
													<div class="modal-body">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="mat_khau" value=""></br >
															<label for="">Lớp</label>
					...
					<div class="panel-body overflow">
						<form action="" method="POST" role="form">
							<div class="form-group">
								...
								<label for="">Mật khẩu</label>
								<input type="text" class="form-control" name="mat_khau" placeholder="Nhập mật khẩu học sinh"></br >
								<label for="">Lớp</label>
								<select name="id_lop" id="inputid_lop" class="form-control" required="required">
									<?php
									for ($j = 0; $j < count($dsl); $j++) {
